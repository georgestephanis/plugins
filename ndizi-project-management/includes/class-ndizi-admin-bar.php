		...
		wp_localize_script(
			...
			array(
				...
				'labels'   => array(
					...
					'no_active_projects'   => __( 'No active projects', 'ndizi-project-management' ),
					...
					'btn_starting'         => __( 'Starting...', 'ndizi-project-management' ),
					'btn_stopping'         => __( 'Stopping...', 'ndizi-project-management' ),
